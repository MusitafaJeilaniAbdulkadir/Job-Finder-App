...
class OnBoarding extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OnBoardingSlider(
      ...
      skipTextButton: CText(
        text: "SKIP",
        decorations: TextDecorations(
            color: Colors.white, fontSize: 20, family: "Poppins SemiBold"),
      ),
      background: [
        Image.asset("assets/job-unlock.png"),
        Image.asset("assets/remote.png"),
        Image.asset("assets/notify-1.png"),
        Hero(tag: "image-1", child: Image.asset("assets/nocard-1.png")),
      ],
      ...
      trailing: CText(
        text: "LOGIN",
        decorations: TextDecorations(
            color: Colors.white, family: "Poppins SemiBold", fontSize: 18),
      ),
      pageBodies: [
        Padding(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                CText(
                  text: "Your Qualifications And Experinece",
                  decorations: TextDecorations(
                      fontSize: 16,
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                CText(
                  text: "Relevant Your Qualification",
                  decorations: TextDecorations(
                      fontSize: 15,
                      color: colors['secondary'] as Color,
                      family: "Poppins Medium"),
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                CText(
                  text: "Your Request, Get Notify Immediately",
                  decorations: TextDecorations(
                      fontSize: 15,
                      color: colors['secondary'] as Color,
                      family: "Poppins Medium"),
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                CText(
                  text: "Feel free to Join, Only Registration",
                  decorations: TextDecorations(
                      fontSize: 16,
                      color: colors['secondary'] as Color,
                      family: "Poppins Medium"),
                ...
                CText(
                  text: "Register Free account as a company",
                  decorations: TextDecorations(
                      fontSize: 16,
                      color: colors['primary'] as Color,
                      family: "Poppins Medium"),
                ...
                CText(
                  text: "or as a user GET STARTED NOW",
                  decorations: TextDecorations(
                      fontSize: 16,
                      color: colors['primary'] as Color,
                      family: "Poppins Medium"),
